...
from core.backend.factory import get_backend, get_backend_info, list_available_backends
...
class TestNumpyBackend:
    ...
    def test_state_serialization(self):
        ...
        assert np.array_equal(
            backend.get_membrane_potentials(), new_backend.get_membrane_potentials()
        )
