...
from api.models.requests import TrainingRequest, ModelConfigRequest
from api.models.responses import TrainingResponse, APIResponse, ChatResponse
    ...
    try:
        ...
        for epoch in range(request.epochs):
            ...
            for i, sample in enumerate(request.input_data):
                if hasattr(brain, 'train_step'):
                    ...
                    result = {"loss": 0.5 - (epoch * 0.05), "accuracy": 0.5 + (epoch * 0.05)}
                    epoch_results.append(result)
        ...
        return TrainingResponse(
            ...
            metrics={
                ...
                "final_accuracy": training_results["learning_curve"][-1]["accuracy"] if training_results["learning_curve"] else 0,
                "improvement": (training_results["learning_curve"][-1]["accuracy"] - training_results["learning_curve"][0]["accuracy"]) if len(training_results["learning_curve"]) > 1 else 0
            }
        )
    ...
    try:
        ...
        return APIResponse(
            ...
            data={
                ...
                "method_available": reset_successful
            }
        )
