...
async def consolidate(
    request: ConsolidateRequest, trainer: ReplayTrainer = Depends(get_replay_trainer)
) -> ConsolidateResponse:
    """
...
@router.get("/metrics")
async def get_metrics(trainer: ReplayTrainer = Depends(get_replay_trainer)) -> Dict[str, Any]:
    """
...
async def get_job(
    job_id: str, trainer: ReplayTrainer = Depends(get_replay_trainer)
) -> Dict[str, Any]:
