...
class KnowledgeSearchRequest(BaseModel):
    ...
    vector_weight: float = Field(default=0.5, ge=0.0, le=1.0, description="Weight for vector similarity")
    spike_weight: float = Field(default=0.5, ge=0.0, le=1.0, description="Weight for spike similarity")
