    ...
    try:
        ...
        return {
            ...
            "vocabulary_stats": {
                ...
                "average_word_frequency": sum(word_frequency.values()) / len(word_frequency) if word_frequency else 0
            },
            "top_learned_words": [
                {"word": word, "frequency": freq, "has_neural_pattern": word in vocabulary}
