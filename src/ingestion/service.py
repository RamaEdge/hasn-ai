...
class QuarantineBuffer:
    ...
    def __init__(self, storage_type: str = "local", storage_path: Optional[str] = None, redis_url: Optional[str] = None):
        """
        ...
        if storage_type == "local":
            ...
            self.redis_client = redis.from_url(redis_url or "redis://localhost:6379", decode_responses=True)
    ...
    def list_items(self, status: Optional[IngestStatus] = None, limit: int = 100) -> List[IngestItem]:
