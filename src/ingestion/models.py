...
class IngestItem(BaseModel):
    ...
    robots_txt_allowed: bool = Field(default=True, description="Whether robots.txt allows ingestion")
...
class TrainingJob(BaseModel):
    ...
    status: TrainingJobStatus = Field(default=TrainingJobStatus.PENDING, description="Current status")
    created_at: datetime = Field(default_factory=datetime.now, description="Creation timestamp")
