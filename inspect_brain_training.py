...
def inspect_brain_storage():
    ...
    try:
        ...
        print(f"   Storage Location: brain.language_module.vocabulary")
        ...
        print(f"   Storage Location: neuron.connections (each neuron)")
        print(f"   Total Neurons: {len(brain.language_module.neurons)}")
        print(f"   Storage Type: In-memory weight matrices")
        ...
        print(f"   Storage Location: brain.language_module.context_associations")
        print(f"   Words with Context: {len(context_assoc)}")
        print(f"   Storage Type: In-memory association lists")
        ...
        print(f"   Storage Location: brain.memory_module['working_memory']")
        print(f"   Current Items: {len(working_memory)}")
        print(f"   Storage Type: In-memory list (sliding window)")
        ...
        print(f"   Storage Location: brain.brain_history")
        print(f"   History Entries: {len(brain_history)}")
        print(f"   Storage Type: In-memory deque (max 50 entries)")
        
        if brain_history:
            latest_state = brain_history[-1]
            print(f"   Latest State: Neural intensity {latest_state.get('neural_intensity', 0):.3f}")
        
        # 6. Response Memory Storage
        print(f"\n6. 💭 RESPONSE MEMORY STORAGE:")
        response_memory = brain.response_generator.response_memory
        print(f"   Storage Location: brain.response_generator.response_memory")
        print(f"   Response History: {len(response_memory)}")
        print(f"   Storage Type: In-memory deque (max 100 entries)")
