...
def scenario_1_learning_and_inference():
    ...
    learning_experiences = [
        ...
        (
            ...
            {
                "concept": "dog",
                "properties": ["animal", "mammal", "pet"],
                "size": "medium",
            },
        ),
        (
            {1: True, 2: True, 11: True},
            {
                "concept": "cat",
                "properties": ["animal", "mammal", "pet"],
                "size": "small",
        ...
        (
            ...
            {
                "concept": "elephant",
                "properties": ["animal", "mammal", "wild"],
                "size": "large",
            },
        ),
        (
            {1: True, 2: True, 13: True},
            {
                "concept": "whale",
                "properties": ["animal", "mammal", "aquatic"],
                "size": "huge",
            },
        ),
        # Birds
        (
            {1: True, 3: True, 20: True},
            {
                "concept": "eagle",
                "properties": ["animal", "bird", "predator"],
                "habitat": "sky",
            },
        ),
        (
            {1: True, 3: True, 21: True},
            {
                "concept": "penguin",
                "properties": ["animal", "bird", "aquatic"],
                "habitat": "ice",
            },
        ),
        # Vehicles
        (
            {4: True, 5: True, 30: True},
            {
                "concept": "car",
                "properties": ["vehicle", "land", "fast"],
                "fuel": "gasoline",
            },
        ),
        (
            {4: True, 5: True, 31: True},
            {
                "concept": "bicycle",
                "properties": ["vehicle", "land", "slow"],
                "fuel": "human",
            },
        ),
        (
            {4: True, 5: True, 32: True},
            {
                "concept": "airplane",
                "properties": ["vehicle", "air", "fast"],
                "fuel": "jet",
            },
        ),
        # Foods
        (
            {6: True, 7: True, 40: True},
            {
                "concept": "apple",
                "properties": ["food", "fruit", "sweet"],
                "color": "red",
            },
        ),
        (
            {6: True, 7: True, 41: True},
            {
                "concept": "carrot",
                "properties": ["food", "vegetable", "crunchy"],
                "color": "orange",
            },
        ),
    ]
...
def scenario_2_temporal_correlations():
    ...
    daily_sequences = [
        ...
        (
            {10: True, 11: True},
            {"activity": "wake_up", "time": "morning", "sequence": 1},
        ),
        (
            {12: True, 13: True},
            {"activity": "brush_teeth", "time": "morning", "sequence": 2},
        ),
        (
            {14: True, 15: True},
            {"activity": "eat_breakfast", "time": "morning", "sequence": 3},
        ),
        (
            {16: True, 17: True},
            {"activity": "go_to_work", "time": "morning", "sequence": 4},
        ),
        # Work routine
        (
            {20: True, 21: True},
            {"activity": "start_computer", "time": "work", "sequence": 1},
        ),
        (
            {22: True, 23: True},
            {"activity": "check_emails", "time": "work", "sequence": 2},
        ),
        (
            {24: True, 25: True},
            {"activity": "attend_meeting", "time": "work", "sequence": 3},
        ),
        # Evening routine
        (
            {30: True, 31: True},
            {"activity": "come_home", "time": "evening", "sequence": 1},
        ),
        (
            {32: True, 33: True},
            {"activity": "cook_dinner", "time": "evening", "sequence": 2},
        ),
        (
            {34: True, 35: True},
            {"activity": "watch_tv", "time": "evening", "sequence": 3},
        ),
        (
            {36: True, 37: True},
            {"activity": "go_to_sleep", "time": "evening", "sequence": 4},
        ),
    ]
    ...
    print("   Query: What typically happens after waking up?")
...
def scenario_3_analogical_reasoning():
    ...
    analogical_experiences = [
        # Size relationships
        (
            {1: True, 10: True, 20: True},
            {
                "analogy": "size",
                "relation": "small_to_large",
                "example": "mouse_to_elephant",
            },
        ),
        (
            {2: True, 11: True, 21: True},
            {
                "analogy": "size",
                "relation": "small_to_large",
                "example": "pebble_to_boulder",
            },
        ),
        (
            {3: True, 12: True, 22: True},
            {
                "analogy": "size",
                "relation": "small_to_large",
                "example": "drop_to_ocean",
            },
        ),
        # Parent-child relationships
        (
            {4: True, 14: True, 24: True},
            {"analogy": "family", "relation": "parent_child", "example": "dog_puppy"},
        ),
        (
            {5: True, 15: True, 25: True},
            {"analogy": "family", "relation": "parent_child", "example": "cat_kitten"},
        ),
        (
            {6: True, 16: True, 26: True},
            {"analogy": "family", "relation": "parent_child", "example": "bird_chick"},
        ),
        # Tool-function relationships
        (
            {7: True, 17: True, 27: True},
            {"analogy": "tool", "relation": "tool_function", "example": "hammer_nail"},
        ),
        (
            {8: True, 18: True, 28: True},
            {"analogy": "tool", "relation": "tool_function", "example": "key_lock"},
        ),
        (
            {9: True, 19: True, 29: True},
            {"analogy": "tool", "relation": "tool_function", "example": "brush_paint"},
        ),
        # Cause-effect relationships
        (
            {30: True, 40: True, 50: True},
            {
                "analogy": "cause_effect",
        ...
        (
            {32: True, 42: True, 52: True},
            {
                "analogy": "cause_effect",
                "relation": "cause_effect",
                "example": "wind_movement",
            },
        ),
    ]
    ...
    print("   Analogy query: seed is to ? as mouse is to elephant")
