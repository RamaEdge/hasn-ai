...
from core.simplified_brain_network import (
    NetworkConfig,
    NetworkPresets,
    SimpleBrainNetwork,
)
...
def example_1_basic_configuration():
    ...
    print("✅ Network created with custom parameters:")
...
def example_2_attention_configuration():
    ...
    print("✅ Network with advanced attention:")
...
def example_6_comparison():
    ...
    for name, config in configs.items():
        print(
            f"{name:<10} {config.learning_rate:<8.3f} {config.learning_probability:<11.2f} "
...
def example_7_custom_attention():
    ...
    print("   Focus on modules 0 and 5 for specialized processing")
    print()
